...
"TwitterMEP", "MEPsProfiles.rds")) %>% select(statuses_count) %>% filter(statuses_count>3200) %>% nrow()` MEPs have tweeted more than 3,200 times. As of October 2017, this means that it is possible to retrieve the full Twitter history of all MEPs effectively only for the last few weeks, and that the most frequent tweeters are left out of calculations for previous periods.
