...
```{r}
 ...
 scale_fill_distiller(type = "seq",
  ...
  labs(title = "Italy's regions sized according to share of votes to...")
```



The map shows some aspects that have featured in analyses of the vote, including the geographic specularity of the electoral success of the two ruling parties (Lega and 5 star movement): *Lega* did better in the north, *Movimento 5 stelle* did better in the South.
...
These maps shows how all parties struggled to get people from Southern regions to come out and vote for them, so even parties such as *Movimento 5 stelle* who performed relativelt better in relative terms in the South, end up with a rather even distribution of actual voters across the peninsula. 



# Cartograms: but why?

Cartograms are not the most effective way to present who got elected. But I think they offer a rather effective way to show regional distribution of votes. These cartograms are also one of those cases when animated maps outperform their static counterpart, as they make it easier to compare changes in a given part of the country, and do not require glancing back and forth or comparing what you see with a stereotyped version of what the viewer has in mind. 
