---
title: 'Beautiful Gantt chart with ggplot2'
...
![*Painful to the eye, but there's no hiding from the truth.*](gantt_img_screenshot.png){width=100%}
...
![*Much better.*](README-gantt_charts_resized_text-1.png){width=100%}
...
![*Nice and easy!*](shiny_ganttrify_screenshot.png){width=100%}
...
It even suggest using colour palettes inspired by Wes Anderson movies ([Tumblr](https://github.com/karthik/wesanderson)/[R package](https://wesandersonpalettes.tumblr.com/)): what's not to like?
